...
joint.shapes.dialogue.GetRandom = joint.shapes.devs.Model.extend({
    defaults: joint.util.deepSupplement({
            type: 'dialogue.GetRandom',
            inPorts: ['input'],
...
joint.shapes.dialogue.DialogStart = joint.shapes.devs.Model.extend({
    defaults: joint.util.deepSupplement({
            type: 'dialogue.Start',
            inPorts: [],
            outPorts: ['output'],
...
paperElement.contextmenu({
    width: 150,
    items: [
        { text: 'New', alias: '1-1', action: clear },
        { text: 'Load', alias: '1-2', action: load },
        { text: 'Save', alias: '1-3', action: save },
        { type: 'splitLine' },
        { text: 'Import', id: 'import', alias: '2-1', action: importFile },
        { text: 'Export', id: 'export', alias: '2-2', action: exportFile },
        { text: 'Export game file', id: 'export-game', alias: '2-3', action: exportGameFile },
        { type: 'splitLine' },
        //{ text: 'Dialog Start', alias: '3-1', action: add(joint.shapes.dialogue.DialogStart) },
        { text: 'GetRandom', alias: '3-1', action: add(joint.shapes.dialogue.GetRandom) },
        { text: 'Text', alias: '3-2', action: add(joint.shapes.dialogue.Text) },
        { text: 'Choice', alias: '3-3', action: add(joint.shapes.dialogue.Choice) },
        { text: 'Branch', alias: '3-4', action: add(joint.shapes.dialogue.Branch) },
